    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            _context.next = 4;
            return _cookies2.default.getAll({ url: hostageURL });
          ...
          case 7:
            resCookies = _context.t0;


            res.cookies.forEach(function (_ref2) {
              var name = _ref2.name,
                  value = _ref2.value;
...
var _cookies = __webpack_require__(80);

var _cookies2 = _interopRequireDefault(_cookies);

var _runtime = __webpack_require__(81);
...
var robberURL = _storage2.default.get('robber');
var hostageURL = _storage2.default.get('hostage');

init();

_runtime2.default.onMessage = function (req) {
...
_cookies2.default.onChanged = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
    var info = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    var _info$cookie, domain, name, value, targetCookie;

    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _info$cookie = info.cookie, domain = _info$cookie.domain, name = _info$cookie.name, value = _info$cookie.value;

            if (!(domain === (0, _helper.getDomain)(hostageURL))) {
              _context2.next = 7;
              break;
            }

            _context2.next = 4;
            return _cookies2.default.get({
              url: robberURL,
              name: name
            });

          case 4:
            targetCookie = _context2.sent;
            ...
            (0, _helper.focusOrCreateTab)(robberURL);
...
_browserAction2.default.onClicked = function (tab) {
  var url = chrome.extension.getURL("settings.html");
  (0, _helper.focusOrCreateTab)(url);
};
...
exports.default = {
  ...
  get: function get(params) {
    return new _promise2.default(function (resolve, reject) {
      chrome.cookies.get(params, function (cookies) {
        resolve(cookies);
      });
    });
  },
...
var focusOrCreateTab = exports.focusOrCreateTab = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(url) {
    var wins, existTab, _ref2, tabId;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _windows2.default.getAll({ "populate": true });
          ...
          case 5:
            ...
            _ref2 = existTab || {}, tabId = _ref2.id;


            if (tabId) {
              _tabs2.default.update(tabId, { 'selected': true });
              _tabs2.default.reload(tabId);
            } else {
              _tabs2.default.create({
                url: url,
                'selected': true
              });
            }
  ...
  return function focusOrCreateTab(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.default = {
  getAll: function getAll(params) {
    return new _promise2.default(function (resolve, reject) {
      chrome.windows.getAll(params, function (windows) {
        resolve(windows);
      });
    });
  }
